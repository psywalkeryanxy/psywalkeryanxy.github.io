...
author:
  - name: Xinyuan Yan
    ...
    url: https://scholar.google.com/citations?hl=zh-CN&user=rdGDTMsAAAAJ&view_op=list_works&sortby=pubdate
  - name: Benjamin Hayden
    affiliation: Baylor College of Medicine
    url: https://scholar.google.com/citations?hl=en&user=MN2ueWEAAAAJ&view_op=list_works&sortby=pubdate
  - name: Sameer Sheth
    affiliation: Baylor College of Medicine
    url: https://scholar.google.com/citations?hl=en&user=lgG2xMgAAAAJ&view_op=list_works&sortby=pubdate
date: "2026-05-03"
categories:
  - neuroscience
  - hippocampus
...
format:
  html:
    ...
    include-after-body:
      - text: |
          <script src="assets/counters.js" defer></script>
comments:
  giscus:
...
The full preprint is available on bioRxiv: [Polysemanticity in Human Hippocampal Neurons](https://www.biorxiv.org/content/10.64898/2026.05.02.722435v1){.track-click data-track="biorxiv-preprint"}.
