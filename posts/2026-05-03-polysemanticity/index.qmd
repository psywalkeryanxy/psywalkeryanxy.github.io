...
![**Hippocampal neurons respond to many unrelated words.** Figure 3A.](figures/hero_polysemantic.png)
...
![**Reading word meaning from hippocampal activity.** Figure 1F, right.](figures/decoding_accuracy.png)
...
![**Neural and semantic geometry align, and the alignment grows with population size.** Figure 1J–M.](figures/rsa_scaling.png)
...
![**Simulated concept cells fail to recover semantic geometry.** Figure S3.](figures/concept_cell_control.png)
...
![**Functional modules cut across semantic categories.** Figure 1O.](figures/nmf_modules.png)
...
![**Modules are overdispersed.**](figures/module_dispersion.png)
...
![**Population sparseness.** Figure 2B.](figures/population_sparseness.png)
...
![**Lifetime sparseness.** Figure 2D.](figures/lifetime_sparseness.png)
...
![**Shannon entropy.** Figure 2E.](figures/shannon_entropy.png)
...
![**Information per word.** Figure 2F.](figures/information_per_word.png)
...
![**Simulated concept cells, for contrast.** Figure 3B.](figures/example_concept_cells.png)
...
![**The geometry of modes.** Figure 3C–F.](figures/mode_geometry.png)
...
![**Context modulates tuning.** Figure 4A.](figures/context_schematic.png)
...
![**Single-neuron tuning shifts across stories.** Figure 4B–C.](figures/within_vs_across_story.png)
...
![**Population geometry is preserved across stories.** Figure 4D–E.](figures/population_geometry_stability.png)
...
![**Word-by-context interactions are widespread.** Figure 4I–J.](figures/wxc_neurons.png)
...
![**Repeated words separate by context.** Figure 5A–C.](figures/pattern_separation.png)
...
![**The semantic geometry generalises.** Figure 5E–H.](figures/ccgp_generalization.png)
